...
@Service//      indha class business logic handle pannum automatic ah object create pannu
...
//booking la showId irukku antha show DB la irukka nu check pannrom illena → exception throw
